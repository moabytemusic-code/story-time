    ...
    return (
        <main className="min-h-screen bg-[#FFF5F9]">
            ...
            <div className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
                ...
                {/* Header Section / Video Player */}
                {story.youtubeId ? (
                    <div className="bg-black rounded-[40px] overflow-hidden shadow-2xl mb-8 aspect-video relative group">
                        <iframe
                            className="w-full h-full"
                            src={`https://www.youtube.com/embed/${story.youtubeId}?autoplay=0&rel=0`}
                            title={story.title}
                            frameBorder="0"
                    ...
                    <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-pink-50 relative overflow-hidden mb-8">
